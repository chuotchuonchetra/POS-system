          ...
          return (
            <div key={product.id} className="rounded-lg border border-slate-200 bg-white p-3">
              <div className="flex gap-3">
                <img src={product.imageUrl} alt={product.name} className="h-20 w-20 rounded-md border border-slate-200 object-cover" />
              ...
              return (
                <tr key={product.id} className="bg-white transition hover:bg-slate-50">
                  ...
                  <td className="px-5 py-3 text-center">
                    <span className={`inline-flex rounded-md px-2.5 py-1 text-xs font-semibold ${product.stock > 10 ? "bg-emerald-50 text-emerald-700" : product.stock > 0 ? "bg-amber-50 text-amber-700" : "bg-red-50 text-red-700"
                      }`}>
                      {product.stock} units
                    </span>
                  </td>
