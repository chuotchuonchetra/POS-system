    ...
    */
    <div className="h-[85vh] flex flex-col overflow-hidden">
      <Tabs defaultValue={'all'} onValueChange={setActiveTab} className="w-full flex flex-col h-full">
        ...
        */}
        <TabsList className="flex flex-wrap h-auto gap-2 bg-transparent p-0 lg:mb-8 xl:mb-10 2xl:mb-4 md:mb-12 shrink-0">
          <TabsTrigger
            value={'all'}
        ...
        <TabsContent
          value={activeTab}
          className="mt-0 outline-none grow overflow-y-auto pr-2 custom-scrollbar"
        >
